...
@section('title', 'Donasi Zakat Penghasilan')

@section('content')
<div class="container mx-auto px-4 py-6 max-w-lg">
    <form method="POST" action="{{ route('campaigns.donate.store', 'zakat-penghasilan') }}" id="donation-form">
        @csrf
        <input type="hidden" name="zakat_type" value="penghasilan">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <h1 class="font-semibold text-gray-900">Zakat Penghasilan</h1>
        ...
        <div class="space-y-6">
            ...
            <!-- Donation Amount -->
            <div>
                <label class="form-label text-center block mb-4">Jumlah Zakat Penghasilan</label>
                <div>
            ...
            <div>
                ...
                <input type="text" id="donor_name" name="donor_name" class="input-field" placeholder="Masukkan nama lengkap">
                <div class="flex items-center mt-3">
                    <input type="checkbox" id="is_anonymous" name="is_anonymous" value="1" class="rounded border-gray-300 text-brand-blue shadow-sm focus:border-brand-blue focus:ring focus:ring-brand-blue focus:ring-opacity-50">
            ...
            <div>
                ...
                <input type="tel" id="donor_whatsapp" name="donor_whatsapp" class="input-field" placeholder="Contoh: 08123456789">
            </div>

            <!-- Email -->
            <div>
                <label for="donor_email" class="form-label">Email (Opsional)</label>
                <input type="email" id="donor_email" name="donor_email" class="input-field" placeholder="Masukkan email">
            </div>

            <!-- Message -->
            <div>
                <label for="message" class="form-label">Pesan/Doa (Opsional)</label>
                <textarea id="message" name="message" rows="3" class="input-field" placeholder="Tulis pesan atau doa"></textarea>
            </div>
