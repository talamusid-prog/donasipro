...
@section('header-button')
    <a href="{{ route('admin.categories.create') }}" class="inline-flex items-center px-2 py-1 md:px-3 md:py-1.5 text-xs md:text-sm bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors duration-200">
